...
class FasilitasHotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/fasilitas-hotel')->with('success','Berhasil Menambahkan!');
    }
    ...
    public function update(Request $request, FasilitasHotel $fasilitasHotel)
    {
        ...
        return redirect('/fasilitas-hotel')->with('success','Berhasil Dirubah!');
    }
    ...
    public function destroy(FasilitasHotel $fasilitasHotel)
    {
        ...
        return redirect('/fasilitas-hotel')->with('success','Berhasil Dihapus!');
    }
}

...
class FasilitasKamarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/fasilitas-kamar')->with('success','Berhasil Menambahkan!');
    }
    ...
    public function update(Request $request, FasilitasKamar $fasilitasKamar)
    {
        ...
        return redirect('/fasilitas-kamar')->with('success','Berhasil Dirubah!');
    }
    ...
    public function destroy(FasilitasKamar $fasilitasKamar)
    {
        ...
        return redirect('/fasilitas-kamar')->with('success','Berhasil Dihapus!');
    }
}
